...
beautiful.init("~/.config/awesome/themes/modified/theme.lua")
...
------------------------------------------------------------------------
   ...
   awful.key({}, "XF86AudioMute", function ()
	...
	awful.key({ modkey, "Shift" }, "Delete", function ()                           
                  awful.util.spawn_with_shell("lxde-logout") end),
        awful.key({ }, "Print" , function ()                                             
                  awful.util.spawn("xfce4-screenshooter -f") end),                        --        awful.key({"Control" }, "Print"  , function ()                                   
...
startup_programs.run("compton")
startup_programs.run("xfce4-power-manager")
startup_programs.run("lxpolkit")
startup_programs.run("conky -c ~/.conky/.conkyrc")
...
poppin.pop("terminal", "lxterminal", "top")
-- Autorun programs
autorun = true
killfirst=true
autorunApps ={
...
if killfirst then
   for appl = 1, #autorunApps do
       awful.spawn.with_shell("killall ".. autorunApps[appl])
   end
   
   awful.spawn.with_shell("killall blueberry-tray")
   awful.spawn.with_shell("killall blueberry-tray.py")
   awful.spawn.with_shell("killall conky")
--   awful.util.spawn("killall synapse")
--   awful.util.spawn("killall wallpaper.sh")
end
...
awful.spawn.with_shell("conky -c ~/.conky/.conkyrc")
--]]
